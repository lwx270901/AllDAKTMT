...
void TLive::LoadModel(void)
{
    ...
    for(int i=0; i<model_num_; ++i){
        ...
        std::string param=  "/home/jp51/workspace/face_recognition_tensorRT/models/live/" + configs_[i].name + ".param";
        std::string model = "/home/jp51/workspace/face_recognition_tensorRT/models/live/"  + configs_[i].name + ".bin";
